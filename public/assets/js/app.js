...
var content = __webpack_require__(/*! !../../../../css-loader??ref--7-1!../../../../postcss-loader/src??ref--7-2!./fancybox.css */ "./node_modules/css-loader/index.js?!./node_modules/postcss-loader/src/index.js?!./node_modules/@fancyapps/ui/dist/fancybox/fancybox.css");
...
/***/ "./node_modules/css-loader/index.js?!./node_modules/postcss-loader/src/index.js?!./node_modules/@fancyapps/ui/dist/fancybox/fancybox.css":
/*!***********************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader??ref--7-1!./node_modules/postcss-loader/src??ref--7-2!./node_modules/@fancyapps/ui/dist/fancybox/fancybox.css ***!
  \***********************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
__webpack_require__(/*! ./modules/fancybox.js */ "./resources/js/web/modules/fancybox.js"); // require('./modules/vhcheck.js');


__webpack_require__(/*! ./modules/project.js */ "./resources/js/web/modules/project.js");

__webpack_require__(/*! ./modules/menu.js */ "./resources/js/web/modules/menu.js");

__webpack_require__(/*! ./modules/touch.js */ "./resources/js/web/modules/touch.js");

__webpack_require__(/*! ./modules/contact.js */ "./resources/js/web/modules/contact.js");

__webpack_require__(/*! ./modules/cv.js */ "./resources/js/web/modules/cv.js");

__webpack_require__(/*! ./modules/worklist.js */ "./resources/js/web/modules/worklist.js");

__webpack_require__(/*! ./modules/team.js */ "./resources/js/web/modules/team.js");
...
(function () {
  ...
  var toggle = function toggle(btn) {
    ...
    var contents = document.querySelectorAll(selectors.content);
    ...
    content.classList.remove(classes.hidden); // add active class to the button
...
/***/ "./resources/js/web/modules/cv.js":
/*!****************************************!*\
  !*** ./resources/js/web/modules/cv.js ***!
  \****************************************/
/*! no static exports found */
...
(function () {
  ...
  var toggle = function toggle(btn) {
    ...
    var content = btn.target.nextElementSibling;
    content.classList.remove('hidden'); // add active class to the button
...
/* harmony import */ var _fancyapps_ui_dist_fancybox_fancybox_css__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_fancyapps_ui_dist_fancybox_fancybox_css__WEBPACK_IMPORTED_MODULE_1__);
...
document.addEventListener('DOMContentLoaded', function () {
  _fancyapps_ui__WEBPACK_IMPORTED_MODULE_0__["Fancybox"].bind('[data-fancybox]', {
    ...
    caption: function caption(fancybox, slide) {
      var _slide$triggerEl, _fancybox$carousel;

      var legend = (_slide$triggerEl = slide.triggerEl) === null || _slide$triggerEl === void 0 ? void 0 : _slide$triggerEl.querySelector("legend");
      var caption = legend ? legend.innerHTML : slide.caption || "";
      var index = "<div>".concat(slide.index + 1, "/").concat((_fancybox$carousel = fancybox.carousel) === null || _fancybox$carousel === void 0 ? void 0 : _fancybox$carousel.slides.length, "</div>");
      return "".concat(index).concat(caption);
    }
  });
}); // end domready
...
(function () {
  ...
  var init = function init() {
    var btnMenu = document.querySelector(selectors.btnMenu);

    if (btnMenu) {
      btnMenu.addEventListener("click", toggle, false);
    }

    var btnMenuParent = document.querySelectorAll(selectors.btnMenuParent);
  ...
  var toggleItems = function toggleItems(btn) {
    ...
    ul.classList.add(classes.current); // remove is-active from all a inside data-menu

    var btns = document.querySelectorAll(selectors.btns);
  ...
  var hideAllItems = function hideAllItems() {
    var uls = document.querySelectorAll(selectors.btnMenuParent + ' + ul');
  ...
  var hideParentStateItems = function hideParentStateItems(btn) {
    var items = document.querySelectorAll('[data-menu-item-state]');
  ...
  var hideParentCategoryItems = function hideParentCategoryItems(btn) {
    var items = document.querySelectorAll('[data-menu-item-category]');
    items.forEach(function (item) {
      item.nextElementSibling.classList.remove(classes.current);
      item.classList.remove(classes.active);
    });
...
(function () {
  ...
  var init = function init() {
    var btnToggleAll = document.querySelector(selectors.btnToggleAll);

    if (btnToggleAll) {
      btnToggleAll.addEventListener("click", toggle, false);
    }

    var btnInfo = document.querySelector(selectors.btnInfo);

    if (btnInfo) {
      btnInfo.addEventListener("click", toggleInfo, false);
    }

    var btnCredits = document.querySelector(selectors.btnCredits);
  ...
  var toggle = function toggle() {
    ...
    var info = document.querySelector(selectors.info);
    info.classList.toggle(classes.hidden);
    var credits = document.querySelector(selectors.credits);
  ...
  var toggleCredits = function toggleCredits() {
    states.hasChange = true;
    var btnCredits = document.querySelector(selectors.btnCredits);
    btnCredits.classList.toggle(classes.active);
    var credits = document.querySelector(selectors.credits);
...
(function () {
  ...
  var toggle = function toggle() {
    var btn = document.querySelector(selectors.btn);
    var content = document.querySelector(selectors.content); // if content has class !hidden, remove the class and add active class to the button
...
/***/ "./resources/js/web/modules/touch.js":
/*!*******************************************!*\
  !*** ./resources/js/web/modules/touch.js ***!
  \*******************************************/
/*! no static exports found */
...
(function () {
  ...
  var init = function init() {
    var touchItems = document.querySelectorAll(selectors.globalItems);
    var touchItemsArray = [].slice.call(touchItems);
...
/***/ "./resources/js/web/modules/worklist.js":
/*!**********************************************!*\
  !*** ./resources/js/web/modules/worklist.js ***!
  \**********************************************/
/*! no static exports found */
...
(function () {
  ...
  var toggle = function toggle(btn) {
    var worklist = document.querySelector(selectors.wrapper); // if the content is already visible, hide it
    ...
    hideAll(); // show the one next to the button if it's hidden

    var content = btn.target.nextElementSibling;
    content.classList.remove('hidden'); // add has-selection class on [data-worklist]

    worklist.classList.add('has-selection'); // remove active class from all buttons in data-worklist

    resetButtons(); // add active class to the button

    btn.target.classList.add('is-active');
  };

  var hideAll = function hideAll() {
    var contents = document.querySelectorAll(selectors.items);
    contents.forEach(function (content) {
      content.classList.add('hidden');
    });
  };
  ...
  setCurrent = function setCurrent() {
    resetButtons();
    var btnCurrent = document.querySelector(selectors.btnCurrent);
    btnCurrent.classList.add('is-active');
  };

  resetButtons = function resetButtons() {
    var btns = document.querySelectorAll(selectors.wrapper + ' a');
    btns.forEach(function (btn) {
  ...
  reset = function reset() {
    hideAll();
    setCurrent();
    var worklist = document.querySelector(selectors.wrapper);
    worklist.classList.remove('has-selection');
  };
...
/***/ 0:
/*!***************************************************************************************************!*\
  !*** multi ./resources/js/web/app.js ./resources/sass/web/app.scss ./resources/sass/cms/app.scss ***!
  \***************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /Users/marceli.to/Jamon.digital/Webroot/baumberger-stegmeier.ch/resources/js/web/app.js */"./resources/js/web/app.js");
__webpack_require__(/*! /Users/marceli.to/Jamon.digital/Webroot/baumberger-stegmeier.ch/resources/sass/web/app.scss */"./resources/sass/web/app.scss");
module.exports = __webpack_require__(/*! /Users/marceli.to/Jamon.digital/Webroot/baumberger-stegmeier.ch/resources/sass/cms/app.scss */"./resources/sass/cms/app.scss");
