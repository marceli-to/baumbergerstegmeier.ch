...
<div>
  ...
  <div v-if="isFetched" class="is-loaded">
    <page-header>
      ...
      <router-link :to="{ name: 'project-category-create'}" class="btn-add has-icon">
      ...
      <draggable 
        ...
        <div
          ...
          <list-actions 
            :id="d.id" 
            :record="d"
            :routes="{edit: 'project-category-edit'}"
            @toggle="toggle($event)"
  ...
  data() {
    return {
      ...
      routes: {
        ...
        store: '/api/project/category',
        delete: '/api/project/category',
        order: '/api/project/category/order',
        toggle: '/api/project/category/state',
      },
