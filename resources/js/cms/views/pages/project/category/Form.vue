...
<div>
  ...
  <form @submit.prevent="submit" v-if="isFetched">
    ...
    <page-footer>
      <button-back :route="'project-category-index'">Zurück</button-back>
...
export default {
  ...
  data() {
    return {
      ...
      // Routes
      routes: {
        find: '/api/project/category',
        store: '/api/project/category',
        update: '/api/project/category',
      },
  ...
  methods: {
    ...
    store() {
      ...
      this.axios.post(this.routes.store, this.data).then(response => {
        this.$router.push({ name: "project-category-index"});
  ...
  computed: {
    title() {
      return this.$props.type == "edit" 
        ? "Projekt-Kategorie bearbeiten" 
        : "Projekt-Kategorie hinzufügen";
    }
  }
};
</script>
