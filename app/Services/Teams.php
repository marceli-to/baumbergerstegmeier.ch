...
{ 
  public function get()
  {
    ...
    $bsemi_employees = $bsemi_team ? Employee::with('team', 'employeeCategory')->where('team_id', $bsemi_team->id)->where('employee_category_id', $bsemi_employees_category->id)->orderBy('name', 'ASC')->get() : [];
